<<<<<<< HEAD
/* ============================================================
   FELIZ DIA DAS MÃES — script.js
   Organização:
   1. CONFIG & STATE
   2. LOADER
   3. PARTÍCULAS (canvas global)
   4. PÉTALA FLUTUANTE
   5. TYPEWRITER
   6. NAVEGAÇÃO ENTRE TELAS
   7. SCROLL REVEAL (timeline)
   8. MOMENT CARDS REVEAL
   9. POLAROID MODAL
   10. REASONS INTERACTION
   11. CARTA LETTER REVEAL
   12. CANVAS FINAL (confetti de corações/flores)
   13. BOTÃO LOVE
   14. INIT
   ============================================================ */
...
>>>>>>> 222a176e6899f6e58f187880e50e2ec40e29f192
})();